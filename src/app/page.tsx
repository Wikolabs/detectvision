...
const P = {
  ...
  testimonials: [
    { quote: "On a deploye DetectVision sur 12 cameras d'entrepot en une journee. En une semaine, deux incidents EPI detectes et une intrusion evitee. Le ROI est immediat.", author: "Patrick M.", role: "Directeur HSE, Groupe logistique" },
    { quote: "La precision sur nos defauts de production depasse notre controle qualite humain. On a reduit les non-conformites de 40% en deux mois.", author: "Sophie T.", role: "Responsable Qualite, Industrie manufacturiere" },
  ],
        ...
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:48 }}>
            ...
            <h2 style={{ fontSize:"clamp(1.8rem,3.5vw,2.8rem)", fontWeight:700, color:txt1, letterSpacing:"-0.02em", fontFamily:"'Instrument Serif',Georgia,serif" }}>
              Operationnel en <em style={{ fontStyle:"italic", color:accent }}>une journee</em>
            </h2>
          </div>
